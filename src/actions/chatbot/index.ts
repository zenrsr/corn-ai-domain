      ...
      if (customerEmail) {
        ...
        if (checkCustomer && !checkCustomer.customer.length) {
          ...
          if (newCustomer) {
            ...
            const response = {
              ...
              }! I'm glad to have you here. Is there anything you need my help with?.`
            };
        ...
        if (checkCustomer && checkCustomer.customer[0].chatRoom[0].live) {
          ...
          if (!checkCustomer.customer[0].chatRoom[0].mailed) {
            ...
            // the mail is being updated to prevent email spamming on the user side
        ...
        if (chatCompletion) {
          ...
          if (generatedLink) {
            ...
            const response = {
              role: "assistant",
              content:
                "Awesome! you can now follow the link to proceed further",
              link: link.slice(0, -1)
            };
