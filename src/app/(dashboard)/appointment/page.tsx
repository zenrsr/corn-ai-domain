...
const Page = async (props: Props) => {
  ...
  console.log(bookingsExistToday);

  return (
    <>
      <InfoBar />
      <div className="grid grid-cols-1 lg:grid-cols-3 flex-1 h-0 gap-5 p-4">
            ...
            bookingsExistToday.map((booking) => (
              ...
              >
                <CardContent className="p-0 flex">
                  <div className="w-4/12 text-xl bg-peach p-10 flex justify-center items-center font-bold">
                    {booking.slot}
                  </div>
